...
public class StringUtil {
	...
	public static String valueOf(Object obj) {
		...
		if(obj instanceof Object[]) {return join((Object[]) obj, ",");}
		if(obj instanceof String[]) {return join((String[]) obj, ",");}
		if(obj instanceof double[]) {return join((double[]) obj, ",");}
		if(obj instanceof long[]) {return join((long[]) obj, ",");}
		if(obj instanceof float[]) {return join((float[]) obj, ",");}
		if(obj instanceof int[]) {return join((int[]) obj, ",");}
		if(obj instanceof short[]) {return join((short[]) obj, ",");}
		if(obj instanceof byte[]) {return join((byte[]) obj, ",");}
