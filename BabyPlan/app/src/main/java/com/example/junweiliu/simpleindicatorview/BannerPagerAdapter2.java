...
public class BannerPagerAdapter2 extends PagerAdapter {
    ...
    public BannerPagerAdapter2(Context context, List<Integer> pictureList) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.goods_detail_imagescroll, container, false);
